...
class VendingMachine:
    ...
    def vend(self) -> str:
        ...
        if self.balance > self.price:
            ...
            self.balance = 0
            self.stock -= 1
            return 'Here is your {0} and ${1} change.'.format(self.product,x-self.price)
...
def pretty_print(obj):
    ...
    """
    print(f'{Colors.OKBLUE}{type(obj).__name__}{Colors.ENDC}'+f'{Colors.OKCYAN}{obj.to_str()}{Colors.ENDC}')
